...
#define CV_SIGNATURE 0x00000001L        // flags should be equal to this
#define CV_SIGNATUR2 0x00000002L        // NB11: flags should be equal to this
...
struct cv_stream_t
{
  ...
  {
    if ( new_end == NULL || new_end > end || new_end < ptr )
      throw bad_cv_t();
    end = new_end;
  }
