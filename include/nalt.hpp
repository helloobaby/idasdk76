...
#ifndef SWIG
  int compare_opinfos(const opinfo_t &r, flags_t flag, int n) const;
#endif
};
...
inline ssize_t idaapi get_archive_path(qstring *buf) { return getinf_str(buf, INF_ARCHIVE_PATH); }
...
inline ssize_t idaapi get_loader_format_name(qstring *buf) { return getinf_str(buf, INF_FILE_FORMAT_NAME); }
...
inline ssize_t idaapi get_initial_ida_version(qstring *ver) { return getinf_str(ver, INF_IDA_VERSION); }

/// Get notead text
inline ssize_t idaapi get_ida_notepad_text(qstring *text) { return getinf_str(text, INF_NOTEPAD); }
...
inline ssize_t idaapi get_srcdbg_paths(qstring *paths) { return getinf_str(paths, INF_SRCDBG_PATHS); }
...
inline ssize_t idaapi get_srcdbg_undesired_paths(qstring *paths) { return getinf_str(paths, INF_SRCDBG_UNDESIRED); }
...
inline ushort idaapi get_initial_ida_version() { return getinf(INF_INITIAL_VERSION); }
