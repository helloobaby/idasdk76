...
// #define BWN_DIFF_MERGE    60 ///< the "Diff/merge" 2-3 panels view
...
// #define IWID_DIFF_MERGE    (1ULL << BWN_DIFF_MERGE   ) ///< diff/merge view   (60)
...
struct addon_info_t
{
  ...
  const char *freeform;     //< any string, e.g. "Copyright (c) 2007-2021 Hex-Rays"
